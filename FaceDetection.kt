...
import kotlinx.android.synthetic.main.bottom_sheet_face_detection.bottom_sheet
...
class FaceDetection : AppCompatActivity() {
    ...
    private fun processFaceDetection(faces: MutableList<FirebaseVisionFace>) {
        ...
        graphic_overlay.clearAnimation()
        ...
        for (i in faces.indices) {
            ...
            val faceGraphic = FaceContourGraphic(graphic_overlay as GraphicOverlay?)
            (graphic_overlay as GraphicOverlay?)!!.add(faceGraphic)
